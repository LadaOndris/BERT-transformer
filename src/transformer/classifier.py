...
from src.transformer.encoder import Dense, TransformerEncoder
...
class TransformerClassifier(nn.Module):
    ...
    def __init__(self, config, num_classes, vocab_size):
        ...
        self.out_layer = Dense(input_dim=conf_trans['dim_model'], hidden_dim=num_classes)
    ...
    def forward(self, x, mask):
        ...
        out = self.out_layer(transformer_out_mean)
